...
full suite runs quickly and deterministically on development machines.
"""
...
ARTIFACTS_DIR = SOURCE_ROOT / ".test-artifacts" / "pi-client" / "tests"


@pytest.fixture()
def artifacts_dir() -> Path:
    """A per-test-session scratch directory under the source-root artifacts."""
